...
StudioEntry studioEntryFromJson(String str) => StudioEntry.fromJson(json.decode(str));
...
class StudioEntry {
    ...
    factory StudioEntry.fromJson(Map<String, dynamic> json) => StudioEntry(
        userKota: userKotaValues.map[json["user_kota"]]!,
