...
class _SportswearDetailPageState extends State<SportswearDetailPage> {
 static const Color primaryBrandColor = darkBlueColor;
 static const Color ratingColor = orangeColor;
 static const Color accentColor = darkBlueColor;
                 ...
                 Image.network(
                   ...
                   errorBuilder: (context, error, stackTrace) {
                     return Container(
                       ...
                       child: const Icon(Icons.shopping_bag, size: 80, color: whiteColor),
                     );
                   },
                 ),
                 Container(
 ...
 Widget _buildInfoRow(String label, String value, {bool isLink = false, bool isSensitive = false}) {
   Widget content = Text(
     ...
     style: TextStyle(
       fontSize: 14,
       color: isLink ? orangeColor : (isSensitive ? Colors.red.shade800 : primaryBrandColor),
   ...
   if (isLink && value.isNotEmpty) {
     // Bungkus konten link dengan InkWell
     content = InkWell(
